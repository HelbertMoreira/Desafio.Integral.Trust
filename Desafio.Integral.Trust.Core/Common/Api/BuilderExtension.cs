...
using Desafio.Integral.Trust.Core.Handlers;
...
namespace Desafio.Integral.Trust.Core.Common.Api
{
    public static class BuilderExtension
    {
        ...
        public static void AddServices(this WebApplicationBuilder builder)
        {
            builder
                .Services
                .AddTransient<ITransactionsHandler, TransactionHandler>();

            builder
                .Services
                .AddTransient<IIndicadoresRiscoHandler, IndicadoresRiscoHandler>();
        }
    }
}
