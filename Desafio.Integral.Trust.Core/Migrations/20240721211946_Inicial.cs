...
namespace Desafio.Integral.Trust.Core.Migrations
{
    /// <inheritdoc />
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "IndicadoresRisco",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeIndicador = table.Column<string>(type: "NVARCHAR(255)", maxLength: 255, nullable: false),
                    ValorIndicador = table.Column<decimal>(type: "MONEY", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndicadoresRisco", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DataReferencia = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TipoTransacao = table.Column<string>(type: "VARCHAR(10)", maxLength: 10, nullable: false),
                    Valor = table.Column<decimal>(type: "MONEY", nullable: false),
                    CodigoMoeda = table.Column<short>(type: "SMALLINT", nullable: false),
